    ...
    return(
        <View style={{flex:1, flexDirection:'column', justifyContent:'center', alignItems:'center'}}>
            ...
            <View style={{flexDirection:'row', justifyContent:'center', alignItems:'center'}}>
                ...
                <PopularTag photo_url={props.tags[3] ? props.tags[1].photo_url : null} tagName={props.tags[3] ? props.tags[3].name : null} width={maxWidth / 2} height={maxHeight}/>
            </View>
            <PopularTag photo_url={props.tags[4] ? props.tags[1].photo_url : null} tagName={props.tags[4] ? props.tags[4].name : null} width={maxWidth} height={maxHeight * 2 / 3}/>
            <View style={{flexDirection:'row'}}>
                <PopularTag photo_url={props.tags[5] ? props.tags[2].photo_url : null} tagName={props.tags[5] ? props.tags[5].name : null} width={maxWidth / 2} height={maxHeight}/>
                <PopularTag photo_url={props.tags[6] ? props.tags[0].photo_url : null} tagName={props.tags[6] ? props.tags[6].name : null} width={maxWidth / 2} height={maxHeight}/>
            </View>
        </View>
    )
}
